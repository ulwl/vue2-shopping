<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="trade in tradeInfo.detailArrayList" :key="trade.skuId">
          <li>
            <img :src="trade.imgUrl" style="width: 100px;">
          </li>
          <li>
            <p>
              {{trade.skuName}}</p>
...
import { mapState } from 'vuex';
  export default {
    ...
    methods: {
      ...
      async submitOrder() {
        // 收货人，手机号，地址
        const {consignee, phoneNum: consigneeTel, userAddress: deliveryAddress} = this.defaultAddress;
        ...
        try {
          ...
          this.$router.push({path: '/pay', query: {orderId: this.$store.state.trade.orderId}});
        } catch (error) {
          alert(error.message);
        }
      }
